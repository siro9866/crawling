...
customOption.add_argument("--start-maximized")  # 브라우저 최대화
customOption.add_argument("--headless") # 브라우저 없이 백단에서실행
customOption.add_argument("--mute-audio") # 브라우저 음소거
# User-Agent 변경도 있음
# 아래 세개는 리눅스에서 적용해야함 (아마도?)
# customOption.add_argument("--headless") # 브라우저 없이 백단에서실행
# customOption.add_argument("--no-sandbox")
# customOption.add_argument("--disable-dev-shm-usase")
